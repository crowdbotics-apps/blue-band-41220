"""
Django settings for blue_band_41220 project.
...
ROOT_URLCONF = 'blue_band_41220.urls'
...
WSGI_APPLICATION = 'blue_band_41220.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_band_41220 API",
    "DESCRIPTION": "API documentation for blue_band_41220 App",
    "VERSION": "v1",
}
